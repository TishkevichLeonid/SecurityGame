...
import com.leo.game1.objects.animationMenu.RightWaveMenu;
...
public class RightWaveMenuActor extends Actor {
    ...
    public void wavesRight() {
        mRightWaveMenu = new RightWaveMenu(480, com.leo.game1.Security.HEIGHT / 2 - AssetLoader.orangeWave.getWidth() / 2 , AssetLoader.orangeWave.getHeight(), AssetLoader.orangeWave.getWidth());
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        for (RightWaveMenu rightWaveMenu : mRightWaveMenuArray) {
            batch.draw(AssetLoader.orangeWave, rightWaveMenu.getX(), com.leo.game1.Security.HEIGHT / 2 - rightWaveMenu.getHeight() / 2 - rightWaveMenu.getWidth() / 2 + 90, rightWaveMenu.getHeight(), rightWaveMenu.getWidth());
        }
